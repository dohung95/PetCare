      ...
      <div className="container mx-auto px-4">
        ...
        <div className="about-grid mb-8">
          ...
          <div className="about-col">
            ...
            <p className="text-lg mb-4">
              We also offer animal protection services with a safe, clean living environment, helping your pets feel comfortable and loved while you are away. Our facility holds a certification from the National FurShield Association for maintaining the highest standards of hygiene and care, and we were recently awarded the "Best Pet Protection Service 2024" by Pet Lovers Magazine.
            </p>
            <p className="text-lg mb-4">
          ...
          <div className="about-col">
            ...
            <div className="core-values-section">
              ...
              <p className="values-conclusion mt-4">
                These values drive us to go above and beyond, making FurShield a place where pets thrive and families grow stronger.
              </p>
            </div>
          </div>
          ...
          <div className="about-col">
            ...
            <div className="why-choose-us-section">
              <div className="choose-us-list space-y-3">
                ...
                <p><strong>Convenience</strong>: Our online store and easy appointment booking make FurShield accessible anytime, anywhere.</p>
                <p><strong>Proven Results</strong>: With certifications and glowing customer reviews, we deliver consistent excellence in FurShield.</p>
              </div>
              <p className="choose-us-conclusion mt-4">
                Choose FurShield and experience the difference of a dedicated team committed to your pet’s well-being.
              </p>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="testimonials-section">
            <div className="testimonials-list">
              ...
              <p>"Booking an appointment was so easy, and the veterinary service was top-notch. Thank you, FurShield!" - Linh T.</p>
              ...
              <p>"FurShield’s customer service is excellent. They helped me choose the perfect accessories!" - James B.</p>
            </div>
          </div>
        </div>
      </div>
